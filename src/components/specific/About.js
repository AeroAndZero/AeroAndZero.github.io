    ...
    return(
        <div className='flex flex-center flex-column mt-80 bg-about w-60 m-auto p-40'>
            ...
            <div className='text-justify'>
                ...
                <br/>
                <br/>
                😄 If you are also in the gaming industry, I would love to <a href="https://bit.ly/at-portfolio-to-linkedin" target='_blank' rel='noreferrer' className='as-button bg-thumbnail'>connect with you on LinkedIn!</a>
                <br/>
                <br/>
